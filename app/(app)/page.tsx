      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              RoboCode Academy and learn from expertly crafted courses,
            ...
            {[
              {
                ...
                role: "Sinh viên",
                content:
                  "RoboCode Academy's đã dạy em rất nhiều kiến thức thực tế mà trường đại học không có. Các dự án thực hành giúp em tự tin hơn khi xin việc.",
                avatar: "🧑‍💻",
              },
              {
                name: "Tuấn Sơn",
                role: "Học viên",
                content:
                  "Các khóa học Pro của RoboCode Academy rất chi tiết và dễ hiểu. Em đã học được nhiều kỹ năng mới và cảm thấy sẵn sàng để bước vào thị trường lao động.",
                avatar: "👩‍💼",
              },
              {
                name: "Phúc Bảo",
                role: "Sinh viên",
                content:
                  "RoboCode Academy's Ultra tier với AI tutor là một trải nghiệm tuyệt vời. Em có thể hỏi bất kỳ câu hỏi nào và nhận được giải thích chi tiết, giúp em học nhanh hơn rất nhiều.",
                avatar: "🎓",
              },
            ].map((testimonial) => (
              <div
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold">RoboCode Academy</span>
            </div>
            ...
            <p className="text-sm text-zinc-600">
              © 2026 RoboCode Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
