...
import { BookOpen, ChevronLeft, ChevronRight, Download } from "lucide-react"; // Thêm Download icon
      ...
      <div className="flex-1 min-w-0">
        {hasAccess ? (
          <>
            ...
            {/* PHẦN MỚI: Hiển thị Lesson Resources (Tài liệu đính kèm) */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {lesson.resources.map((resource: any, index: number) => (
                    <a
                      ...
                      className="flex items-center gap-3 p-4 bg-zinc-800/50 border border-zinc-700 rounded-lg hover:border-violet-500/50 hover:bg-zinc-800 transition-all group"
                    >
                      <div className="p-2 bg-zinc-900 rounded text-zinc-400 group-hover:text-violet-400">
